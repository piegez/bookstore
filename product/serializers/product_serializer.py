...
class ProductSerializer(serializers.ModelSerializer):
    ...
    category = CategorySerializer(many=True, read_only=True)  # Certifique-se de que esse campo está presente
    ...
    def create(self, validate_data):
        ...
        product.category.set(category_data)  # Use set para garantir que as categorias estão associadas corretamente
        return product